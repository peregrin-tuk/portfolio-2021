    ...
    <div class="min-h-screen h-full w-full bg-gradient-reverse">
        <div class="max-w-7xl h-auto pt-12 pb-20 sm:px-0 sm:pt-36 mx-auto">
            ...
            <div class="w-full min-h-152 flex flex-wrap justify-center relative z-10">
                <project-card v-show="typeof projects[0] !== undefined" alignmentClass="self-end"    :tag="projects[0].tag" :title="projects[0].title" :teaser="projects[0].teaser" :image="projects[0].image" />
                <project-card v-show="typeof projects[1] !== undefined" alignmentClass="self-center" :tag="projects[1].tag" :title="projects[1].title" :teaser="projects[1].teaser" :image="projects[1].image" />
                <project-card v-show="typeof projects[2] !== undefined" alignmentClass="self-start"  :tag="projects[2].tag" :title="projects[2].title" :teaser="projects[2].teaser" :image="projects[2].image" />
            </div>
        </div>
    </div>
</template>
